   ...
   $url = "http://66.45.237.70/api.php";
       ...
       $sendstatus = $p[0];
        ...
        public static function sentsmscustomerbillpaid($smsinfo){
            $smssetting=Smssent::whereadmin_id(Auth::id())->firstOrFail();
         $text= str_replace(['#CUSTOMER_NAME#', '#AMOUNT#','#IP_OR_USER_NAME_OR_ID#','#DUE_AMOUNT#','#COMPANY_NAME#'], [$smsinfo['name'],$smsinfo['paid'], $smsinfo['id'],$smsinfo['due'],Auth::user()->company], $smssetting->paymentmessage);
