        ...
        <div class="card-content invoice-print-area">
          ...
          <div class="row mt-3 invoice-logo-title">
            <div class="col m6 s12 display-flex invoice-logo mt-1 push-m6">
              <img  src="{{@url('storage/app/files/shares/uploads/'.$customer->path.'/'.$customer->photo)}}" height="46" width="164">
                  ...
                  <div class="col m12 s12">
                    <table class="responsive-table">
                        ...
                        <tbody>
                          <tr style="border: 0;">
                            <td>Customer ID:</td>
                            <td style="align-items: center; display: flex;">{{$customer->id}}  <a href="exchange" class="ml-5"><i class="material-icons">swap_horiz</i></a> <a href="delete" class="ml-5"><i class="material-icons">delete</i></a></td>
                          </tr>
                          <tr style="border: 0;">
                            <td>Login ID:</td>
