                              ...
                              <div class="card-content">
                                  ...
                                  <div class="row">
                                      ...
                                      <div class="col s2 circle p-0">
                                          <a href="#"> <img  src="{{@url('storage/app/files/shares/uploads/'.Auth::guard('customer')->user()->path.'/'.Auth::guard('customer')->user()->photo)}}" alt="avatar"></a>
                                  ...
                                  <table>
                                      ...
                                      <tbody>
                                          <tr style="border: 0;">
                                              ...
                                              <td>{{@Auth::guard('customer')->user()->id}}</td>
                                          </tr>
                                          <tr style="border: 0;">
                                              <td style="font-weight: 700">Login/User ID:</td>
                                              <td>{{@Auth::guard('customer')->user()->loginid}}</td>
                                          </tr>
                                          <tr style="border: 0;">
                                          ...
                                          <tr style="border: 0;">
                                              ...
                                              <td>@if (Auth::guard('customer')->user()->status==1)
                                                  Active
                                                  @else
                                                  In-Active
                                              @endif
                                          ...
                                          <tr style="border: 0;">
                                              ...
                                              <td>{{@Auth::guard('customer')->user()->due}} BDT. </td>
                                          </tr>
                                          <tr style="border: 0;">
                                          ...
                                          <tr style="border: 0;">
                                              ...
                                              <td>{{@Auth::guard('customer')->user()->package->packagename}} Mbps_Sourav </td>
                                          </tr>
                                          <tr style="border: 0;">
                                              <td style="font-weight: 700">Monthly Plan Rate:</td>
                                              <td>{{@Auth::guard('customer')->user()->monthlyrent}} BDT</td>
                                          </tr>
...
<div class="row">
  ...
  <div class="col m4 s12">
      <a href="{{url('customer/complainlist')}}">
          <div class="card-panel mt-0 center" style="padding: 16px 13px;">
